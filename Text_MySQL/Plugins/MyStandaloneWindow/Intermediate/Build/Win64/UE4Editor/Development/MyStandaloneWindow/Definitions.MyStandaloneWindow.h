#undef MYSTANDALONEWINDOW_API
#undef MYSTANDALONEWINDOW_VTABLE
...
#define UE_PROJECT_NAME Text_MySQL
...
#define MYSTANDALONEWINDOW_VTABLE DLLEXPORT_VTABLE
#define MYSTANDALONEWINDOW_API DLLEXPORT
